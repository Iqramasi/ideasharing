...
// const mongoose = require('mongoose'); // For your existing Idea model
...
// // --- MongoDB Connection (for your existing Idea model) ---
...
// // by creating a Mongoose User Schema and Model, similar to your Idea model.
// // This in-memory array will reset every time the server restarts.
...
// // ===========================================
// //  YOUR EXISTING IDEA ROUTES
// // ===========================================
// // This line should remain exactly as it was.
// // Ensure the path './routes/ideas' correctly points to your ideas.js file.
// const ideaRoutes = require('./routes/ideas');
// app.use('/api/ideas', ideaRoutes); // All routes in ideaRoutes will be prefixed with /api/ideas
...
// // Basic default route for testing if the server is running
// app.get('/', (req, res) => {
//     res.send('Combined Backend API is running!');
// });
